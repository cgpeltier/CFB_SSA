...
box.score.stats <- advanced.stats2 %>%
  ...
  summarize(
    ...
    avg.sr.gain = mean(yardsgained[success==1]),
...
season.stats.off <- season.stats.off %>%
  ...
  mutate(
    ...
    avg.sr.gain.rank = dense_rank(desc(avg.sr.gain)),
...
col_order <- c("offense", "ypp", "ypp.rank", "plays", "yards", "drives", "success.rte", "sr.rank", "rush.sr", "rush.sr.rank", "pass.sr", "pass.sr.rank",
               ...
               "exp.rte.pass", "exp.rte.pass.rank", "avg.sr.gain", "avg.sr.gain.rank", "rush.rte", "rush.rte.rank", "std.down.rush.rte", "std.down.rush.rte.rank", "pass.down.rush.rte", "pass.down.rush.rte.rank",
...
season.stats.def <- season.stats.def %>%
  ...
  mutate(
    ...
    avg.sr.gain.rank = dense_rank(avg.sr.gain),
...
col_order <- c("defense", "ypp", "ypp.rank", "plays", "yards", "drives", "success.rte", "sr.rank", "rush.sr", "rush.sr.rank", "pass.sr", "pass.sr.rank",
               "ypp.rush", "ypp.rush.rank", "ypp.pass", "ypp.pass.rank", "stuff.rte", "stuff.rte.rank",
               "opp.rte", "opp.rte.rank", "exp.rte", "exp.rte.rank", "exp.rte.rush", "exp.rte.rush.rank",
               "exp.rte.pass", "exp.rte.pass.rank", "avg.sr.gain", "avg.sr.gain.rank", "rush.rte", "rush.rte.rank", "std.down.rush.rte", "std.down.rush.rte.rank", "pass.down.rush.rte", "pass.down.rush.rte.rank", "yds.to.go.3d", "yds.to.go.3d.rank",
